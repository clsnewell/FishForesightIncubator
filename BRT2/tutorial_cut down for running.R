...
#From Simon Dedman: Just because you CAN try every conceivable combination of tc, lr, bf, all, at once doesn’t mean you should. Try a range of lr in shrinking orders of magnitude from 0.1 to 0.000001, find the best, THEN try tc c(2, n.expvars), find the best THEN bf c(0.5, 0.75, 0.9) and then in between if either outperform 0.5.
...
source("C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/brt.functions.CarolineComments.R")
...
model.data <- read.csv("C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/model.data.csv")
...
str(model.data) #Need each variable to be numeric or factor.
model.data$Method<-as.factor(model.data$Method)
model.data$DSDam<-as.numeric(model.data$DSDam)
model.data$Site<-as.numeric(model.data$Site)
model.data$Angaus<-as.numeric(model.data$Angaus)
...
# For a discussion of simplification see Appendix 2 of the online supplement to Elith et al (2008). Simplification builds many models, so it can be slow. For example, the code below took a few minutes to run on a modern 2008 laptop. In it we assess the value in simplifying the model built with a lr of 0.005, but only test dropping up to 5 variables (the "n.drop" argument; the default is an automatic rule so it continues until the average change in predictive deviance exceeds its original standard error as calculated in gbm.step).
...
par(mfrow=c(3,4))
gbm.plot(angaus.tc5.lr005, n.plots=12, write.title = F) #CLASSIC PLOTS FOR RESULTS
...
gbm.perspec(angaus.tc5.lr005,7,1,y.range = c(15,20), z.range=c(0,0.6)) #3D PLOT
...
eval.data <- read.csv("C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/eval.data.csv", as.is=T)
...
# Import them into R:
dsdam.asc<-("C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/dsdam.asc")
dsdist.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/dsdist.asc"
dsmaxslope.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/dsmaxslope.asc"
locsed.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/locsed.asc"
mask.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/mask.asc"
seglowflow.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/seglowflow.asc"
segsumt.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/segsumt.asc"
segtseas.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/segtseas.asc"
usavgt.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/usavgt.asc"
usnative.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/usnative.asc"
usraindays.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/usraindays.asc"
usslope.asc<-"C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/usslope.asc"
...
gbm.predict.grids(angaus.tc5.lr005, preddat, want.grids = T, sp.name = "angaus_preds",pred.vec = rep(-9999,49000), filepath = "C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/", num.col = 250, num.row = 196, xll = 0, yll = 0, cell.size = 100, no.data = -9999, plot=T) 
...
gbm.predict.grids(angaus.tc5.lr005, preddat, want.grids = T, sp.name = "angaus_preds2",pred.vec = rep(-9999,250 * rep.rows[1]), filepath = "C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/", num.col = 250, num.row = 196, xll = 0, yll = 0, cell.size = 100, no.data = -9999, plot=T, full.grid = F, part.number = 1, part.row = rep.rows[1]) 
...
gbm.predict.grids(angaus.tc5.lr005, preddat, want.grids = T, sp.name = "angaus_preds2",pred.vec = rep(-9999,250 * rep.rows[i]), filepath = "C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/BRT2/data/", num.col = 250, full.grid = F, part.number = i, part.row = rep.rows[i], header = F) 
}
