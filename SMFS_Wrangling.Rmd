...
unique(SMFS_Integrate_Expand$Class)
SMFS_Integrate_Expand$FishID<-1:69998
...
unique(SMFS_Integrate_Expand$OrganismCode) #77 including non-fish
SMFS_Integrate_t<- SMFS_Integrate_Expand %>% 
...
AgedFish<-SMFS_Integrate_Expand %>% filter(OrganismCode%in%c("LFS", "SB", "TP", "STAG", "SF", "CP", "DS", "ISS", "WCF", "TFS", "ST", "STBK", "SCP", "SKR", "BF", "BLB", "CCF", "CS", "HCH", "MQF", "NAC", "PH", "RWK", "SPM", "WAK", "WC", "WS", "YFG", "ASH", "SG", "SKG", "BC", "GF")) 
...
BringEmBack<-SMFS_Integrate_Expand %>% filter(!OrganismCode %in% c("LFS", "SB", "TP", "STAG", "SF", "CP", "DS", "ISS", "WCF", "TFS", "ST", "STBK", "SCP", "SKR", "BF", "BLB", "CCF", "CS", "HCH", "MQF", "NAC", "PH", "RWK", "SPM", "WAK", "WC", "WS", "YFG", "ASH", "SG", "SKG", "BC", "GF")) %>% mutate(Max = NA, Min = NA, AgeClass = "N/A")
