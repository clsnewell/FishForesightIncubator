...
WrangledSMFSForIntegration<-read_csv("C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/Data/SMFS_WithAbsences_062024.csv")
...
SMFS_Afer2010<-WrangledSMFSForIntegration %>% filter(Year > 2010) #Filtering out years which overlap with South Bay Otter Trawl Survey for my thesis work.
...
WieLang<-unique(presabs$SampleRowID) #3433
```
...
```{r}
#Save New DF
write.csv(presabs, "C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/Data/SMFS_Thesis_PresAbs.csv")
