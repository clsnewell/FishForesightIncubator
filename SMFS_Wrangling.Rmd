...
SMFS_Thesis<-mutate(SMFS_Thesis, gensp = paste(Genus, Species, sep=" "))
...
```{r}
SMFS_Thesis_Expand <- SMFS_Thesis %>%
...
SMFS_Thesis_Expand$Count<-1 #assigns value of 1

Bind<-SMFS_Thesis %>%
  filter(!StandardLength > 0)
SMFS_Thesis_Expand2<-rbind(SMFS_Thesis_Expand, Bind)
#Save New DF
write.csv(SMFS_Thesis_Expand2, "C:/Users/cnewe/OneDrive/Documents/Incubator/Code/FishForesightIncubator/Data/SMFS_OneFishOneRow.csv")
