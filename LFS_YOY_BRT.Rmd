...
LFS %>% ggplot(aes(x=StandardLength, fill=Type)) + geom_histogram() + ggtitle("Length distribution of Longfin smelt 2011-2023") + theme(text=element_text(size=20)) + facet_wrap(LFS$Month)
```
