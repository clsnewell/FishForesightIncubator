...
```{r}
SMFS_Thesis <- read_csv("Data/SMFS_Thesis.csv") #this dataset includes all SMFS data 
...
SMFS_AgesBySizeMo<-SMFS_AgesBySizeMo %>% mutate(Max = case_when(OrganismCode == "HCH" & Month == 1 ~ 267,
                          ...
                          OrganismCode == "ASH" & Month == 8  ~ 461, TRUE~Max)) #This code ups the maxes for the 3 fish previously being deleted.
...
glimpse(Raw_AgeClasses) #58,647 rows and 52 columns of measured fish with plus count fish. Why did I gain 9 rows? I think there is a problem with the age class table - overlapping min/max perhaps?

LostRows<-anti_join(Raw_AgeClasses, Raw) 
